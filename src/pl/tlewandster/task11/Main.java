...
public class Main {
    ...
    private static void tests() {
        ...
        System.out.println(someTwoKeyMap.put("C","A",4));
        System.out.println(someTwoKeyMap.put("D","B",5));
        System.out.println(someTwoKeyMap.put("Z","Z",10));
        ...
        System.out.println(someTwoKeyMap.remove("Z","Z"));
        System.out.println(someTwoKeyMap);
